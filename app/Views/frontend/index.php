...
<section class="bg-white py-16 fade-in-section">
  <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2">
    ...
    <div class="relative flex justify-end group">
      ...
      <div class="hidden lg:block absolute top-1/2 -left-8 -translate-y-1/2 
                  bg-background-light shadow-2xl rounded-2xl p-8 w-[19rem] 
  ...
  <div class="flex gap-4 items-start">
      <div class="flex-shrink-0 w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center text-justify">
      ...
      <div class="flex-1">
          ...
          <p class="text-textbody-light text-sm mt-1 leading-relaxed break-words">
              <?= esc($contact_info->location) ?>
          </p>
      </div>
  </div>
