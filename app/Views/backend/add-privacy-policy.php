<main class="p-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-bold text-primary">Add New Privacy Policy</h2>
            <p class="text-gray-500">Fill out the form to add a new privacy policy section</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="p-6">
            <form method="post" action="<?= base_url('admin/privacy-policies/save') ?>">
                <?= csrf_field() ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="card_content" rows="3"
                            class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-primary focus:border-primary"
                            placeholder="Card content description" required></textarea>
                    </div>
                ...
                <div class="mt-8 flex justify-end space-x-3">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-save mr-2"></i> Save Privacy Policy
                    </button>
                </div>
            </form>
        </div>
