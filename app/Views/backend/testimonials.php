...
<main class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-secondary-dark">Testimonials Section</h2>
        ...
        <div class="bg-white rounded-lg shadow p-4 mb-4 flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            ...
            <div class="flex items-center max-w-xs w-full">
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" id="search" placeholder="Search Name or Designation..."
                ...
                <tbody>
                    <?php foreach ($testimonials as $index => $item): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4">
                                <?php if (!empty($item->image) && file_exists('assets/img/testimonials/' . $item->image)): ?>
                                    <img src="<?= base_url('assets/img/testimonials/' . $item->image) ?>" alt="<?= esc($item->name) ?>" class="w-12 h-12 rounded-full object-cover">
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4 text-left">
                                <a href="<?= base_url('admin/testimonials/edit/' . $item->id) ?>"
                                ...
                                <a href="<?= base_url('admin/testimonials/delete/' . $item->id) ?>"
