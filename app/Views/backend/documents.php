...
<main class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-secondary">Documents Section</h2>
        <a href="<?= base_url('admin/documents/add') ?>"
        ...
        <div
            ...
            <div class="flex items-center max-w-xs w-full">
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" id="search" placeholder="Search Document..."
            ...
            <table id="servicesTable" class="table table-striped table-bordered w-full text-sm md:text-base">
                <thead class="bg-gray-200 border border-gray-900">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs uppercase">Document Name</th>
                        <th class="px-6 py-3 text-left text-xs uppercase">Sort Order</th>
                ...
                <tbody>
                    <?php foreach ($documents as $index => $item): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4"><?= esc($item->document_name) ?></td>
                            <td class="px-6 py-4"><?= esc($item->sort_order) ?></td>

                            <td class="px-6 py-4 text-left">
                                <a href="<?= base_url('admin/documents/edit/' . $item->id) ?>"
                                ...
                                <a href="<?= base_url('admin/documents/delete/' . $item->id) ?>"
