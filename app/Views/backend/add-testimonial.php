...
<main class="p-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-bold text-primary">Add New Testimonial</h2>
            <p class="text-gray-500">Fill out the form to add a new Testimonial</p>
        </div>
        ...
        <div class="p-6">
            <form method="post" action="<?= base_url('admin/testimonials/save') ?>" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <h5 class="text-lg font-semibold text-secondary-dark md:col-span-2">Testimonial Details</h5>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="heading"
                               class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-primary focus:border-primary"
                               placeholder="e.g. Amazing Experience at Flyvista Academy">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="feedback" rows="4"
                                  class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-primary focus:border-primary"
                                  placeholder="Write the testimonial feedback here..." required></textarea>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg">
                            ...
                            <img id="testimonial-image-preview" class="hidden mx-auto mb-4 max-h-48 rounded-full object-cover" />
                            ...
                            <div class="space-y-1 text-center">
                                <label class="relative cursor-pointer bg-white rounded-md font-medium text-primary">
                                    ...
                                    <input type="file" name="image" class="sr-only" accept="image/*"
                                           onchange="previewFlyvistaImage(event,'testimonial-image-preview')">
                                </label>
