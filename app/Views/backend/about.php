            ...
            <table id="servicesTable" class="table table-striped table-bordered w-full text-sm md:text-base">
                <thead class="bg-gray-200 border border-gray-900">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs uppercase">Tag</th>
                ...
                <tbody>
                    <?php foreach ($about as $index => $item): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4"><?= esc($item->tag_text) ?></td>
                            <td class="px-6 py-4"><?= esc($item->heading) ?></td>

                            <td class="px-6 py-4 text-left">
                                <a href="<?= base_url('admin/about/edit/' . $item->id) ?>"
                                ...
                                <a href="<?= base_url('admin/about/delete/' . $item->id) ?>"
