...
<main class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-secondary-dark">Mission & Vision</h2>
        <a href="<?= base_url('admin/mission-vision/add') ?>"
        ...
        <div class="bg-white rounded-lg shadow p-4 mb-4 flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            ...
            <div class="flex items-center max-w-xs w-full">
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" id="search" placeholder="Search Mission Title..."
            ...
            <table id="servicesTable" class="table table-striped table-bordered w-full text-sm md:text-base">
                <thead class="bg-gray-200 border border-gray-900">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs uppercase">Mission Title</th>
                        <th class="px-6 py-3 text-left text-xs uppercase">Vision Title</th>
                        <th class="px-6 py-3 text-left text-xs uppercase">Badge Title</th>
                ...
                <tbody>
                    <?php foreach ($missionvision as $index => $item): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4"><?= esc($item->mission_title) ?></td>

                            <td class="px-6 py-4"><?= esc($item->vision_title) ?></td>

                            <td class="px-6 py-4"><?= esc($item->badge_title) ?></td>

                            <td class="px-6 py-4 text-left">
                                <a href="<?= base_url('admin/mission-vision/edit/' . $item->id) ?>"
                                ...
                                <a href="<?= base_url('admin/mission-vision/delete/' . $item->id) ?>"
