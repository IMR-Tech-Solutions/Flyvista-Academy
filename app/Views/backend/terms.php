...
<main class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-secondary-dark">Terms & Conditions</h2>
        <a href="<?= base_url('admin/terms/create') ?>"
                ...
                <tbody>
                    <?php foreach ($terms as $index => $term): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4"><?= esc($term->section) ?></td>
                            <td class="px-6 py-4"><?= esc($term->heading) ?></td>
                            <td class="px-6 py-4"><?= esc($term->card_title) ?></td>
                            <td class="px-6 py-4"><?= esc($term->order_in_section) ?></td>
                            <td class="px-6 py-4 text-left">
                                <a href="<?= base_url('admin/terms/edit/' . $term->id) ?>"
                                ...
                                <a href="<?= base_url('admin/terms/delete/' . $term->id) ?>"
