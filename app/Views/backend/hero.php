...
<main class="p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?= base_url('admin/hero/add') ?>"
            ...
            <table id="servicesTable" class="table table-striped table-bordered w-full text-sm md:text-base">
                <thead class="bg-gray-200 border border-gray-900">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs uppercase">Tagline</th>
                ...
                <tbody>
                    <?php foreach ($heros as $index => $hero): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4"><?= esc($hero->tagline) ?></td>
                            <td class="px-6 py-4"><?= esc($hero->title) ?></td>
                            <td class="px-6 py-4 text-left">
                                <a href="<?= base_url('admin/hero/edit/' . $hero->id) ?>"
                                ...
                                <a href="<?= base_url('admin/hero/delete/' . $hero->id) ?>"
