<main class="p-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-bold text-primary">Add New Term</h2>
            <p class="text-gray-500">Fill out the form to add a new Terms & Conditions section</p>
        </div>
        ...
        <a href="<?= base_url('admin/terms') ?>"
            ...
            <i class="fas fa-arrow-left mr-2"></i> Back to Terms & Conditions
        </a>
    </div>

    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="p-6">
            <form method="post" action="<?= base_url('admin/terms/store') ?>">
                <?= csrf_field() ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="card_title"
                            class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-primary focus:border-primary"
                            placeholder="Card titles separated by commas">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Card Icon</label>
                        <input type="text" name="card_icon"
                            class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-primary focus:border-primary"
                            placeholder="Card icons separated by commas, e.g. fas fa-user, fas fa-lock">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="card_content" rows="3"
                            class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-primary focus:border-primary"
                            placeholder="Card contents separated by newlines" required></textarea>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Order in Section</label>
                        <input type="number" name="order_in_section"
                            class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-primary focus:border-primary"
