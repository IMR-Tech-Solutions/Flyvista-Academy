...
<main class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-secondary-dark">Why Choose Section</h2>
        <a href="<?= base_url('admin/why-choose/add') ?>"
        ...
        <div class="bg-white rounded-lg shadow p-4 mb-4 flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            ...
            <div class="flex items-center max-w-xs w-full">
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" id="search" placeholder="Search Heading or Title..."
                ...
                <tbody>
                    <?php foreach ($cards as $index => $item): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4">
                                <i class="<?= esc($item->icon) ?> text-primary text-xl"></i>
                            </td>
                            <td class="px-6 py-4"><?= esc($item->title) ?></td>

                            <td class="px-6 py-4 text-left">
                                <a href="<?= base_url('admin/why-choose/edit/' . $item->id) ?>"
                                ...
                                <a href="<?= base_url('admin/why-choose/delete/' . $item->id) ?>"
