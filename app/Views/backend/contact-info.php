...
<main class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-secondary-dark">Contact Information</h2>

        <a href="<?= base_url('admin/contact-info/add') ?>"
                ...
                <tbody>
                    <?php foreach ($contact as $index => $item): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4"><?= esc($item->location) ?></td>
                            <td class="px-6 py-4"><?= esc($item->phone) ?></td>
                            <td class="px-6 py-4"><?= esc($item->email) ?></td>

                            <td class="px-6 py-4 text-left">
                                <a href="<?= base_url('admin/contact-info/edit/' . $item->id) ?>"
                                ...
                                <a href="<?= base_url('admin/contact-info/delete/' . $item->id) ?>"
