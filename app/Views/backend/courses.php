...
<main class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-secondary">Courses Section</h2>
        <a href="<?= base_url('admin/courses/add') ?>"
                    ...
                    <?php foreach ($courses as $index => $item): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4 text-left">
                                <a href="<?= base_url('admin/courses/edit/' . $item->id) ?>"
                                ...
                                <a href="<?= base_url('admin/courses/delete/' . $item->id) ?>"
