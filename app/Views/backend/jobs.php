...
<main class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-secondary">Jobs</h2>
        <a href="<?= base_url('admin/jobs/add') ?>"
            ...
            <table id="servicesTable" class="table table-striped table-bordered w-full text-sm md:text-base">
                <thead class="bg-gray-200 border border-gray-900">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs uppercase">Job Title</th>
                        <th class="px-6 py-3 text-left text-xs uppercase">Location</th>
                        <th class="px-6 py-3 text-left text-xs uppercase">Job Type</th>
                ...
                <tbody>
                    <?php foreach ($jobs as $index => $job): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4"><?= esc($job->title) ?></td>
                            <td class="px-6 py-4"><?= esc($job->location) ?></td>
                            <td class="px-6 py-4"><?= esc($job->job_type) ?></td>
                            <td class="px-6 py-4"><?= esc($job->category) ?></td>
